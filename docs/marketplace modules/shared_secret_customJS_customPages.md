...
Eleva CRM provides a secure mechanism for accessing authenticated user information through signed tokens. This guide explains how you can generate and use `Shared Secret` key to access user context in secured manner.
...
If you're using custom JavaScript injected into Eleva CRM pages, use the `exposeSessionDetails` method:
...
[GoEleva CRM Marketplace App Template](https://elevabuilds.com)
