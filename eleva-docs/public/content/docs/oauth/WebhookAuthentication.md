...
Please keep an eye on your email and [our social channels](https://elevabuilds.com/support) for notices regarding public key rotation to stay updated. The public key in this doc is the one to use to validate the webhook payload.
