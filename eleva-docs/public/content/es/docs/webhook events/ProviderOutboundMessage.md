...
# Proveedor de conversación - Mensaje saliente

Se dispara cuando un usuario envía un mensaje a un contacto y tiene un proveedor personalizado como canal por defecto.
