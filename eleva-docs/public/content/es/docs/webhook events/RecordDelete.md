...
## Resumen
El webhook se dispara cuando se elimina un registro o business (compañía) del sistema.

## Schema
El payload del webhook sigue un esquema JSON que define el formato y los tipos de datos del evento.
