...
Este webhook se dispara cuando se elimina una asociación entre objetos. Actualmente solo se admiten asociaciones contacto-contacto, contacto-objeto personalizado y objeto personalizado-objeto personalizado.
