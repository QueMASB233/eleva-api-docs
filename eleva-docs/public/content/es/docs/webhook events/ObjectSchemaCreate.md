...
# Crear esquema de objeto

## Resumen

Este webhook se dispara cuando se crea un objeto personalizado. Permite reaccionar a nuevos objetos personalizados y ejecutar acciones según el evento.
